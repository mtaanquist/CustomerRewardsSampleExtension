codeunit 50101 "CONIT Cust. Rewards Ext. Mgt."
{
    var
    ...
    var
        ActivationCodeInfo: Record "CONIT Activation Code Info";
    begin
    ...
    var
        CustomerRewardsWizard: Page "CONIT Customer Rewards Wizard";
    begin
    ...
    var
        RewardsLevelPage: Page "CONIT Rewards Level List";
    begin
    ...
    var
        RewardLevelRec: Record "CONIT Reward Level";
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::"CONIT Cust. Rewards Ext. Mgt.", 'OnGetActivationCodeStatusFromServer', '', false, false)]
    ...
    begin
        ...
        Customer."CONIT Reward Points" += 1; // Add a point for each new sales order 
        Customer.Modify();
    end;
    ...
    begin
        if CustomerRewardsExtMgtSetup.Get() then
            exit(CustomerRewardsExtMgtSetup."Extension Mgt. Codeunit ID" = CODEUNIT::"CONIT Cust. Rewards Ext. Mgt.");
        exit(false);
    end;
}